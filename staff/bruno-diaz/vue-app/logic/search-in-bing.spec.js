describe('searchInBing', () => {
    it('should succeed when query matches results in Bing', async () => {
        ...
        const { results, page: pageBack } = await searchInBing(query, page) 
