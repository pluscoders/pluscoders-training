...
function createHeader(user, onEditProfile, onLogout) {
...
function createSession(user, onEditProfile, onLogout, onSearch) {
    var pagWelcome = document.createElement('div')

    var header = createHeader(user, onEditProfile, onLogout)
